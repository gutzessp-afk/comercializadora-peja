...
export default function DocumentoEditor({ clientes }: { clientes: Cliente[] }) {
  ...
  function actualizarPartida(i: number, campo: keyof Partida, valor: string) {
    setPartidas((prev) => {
      ...
      if (campo === "descripcion") {
        ...
        p.cantidad = parseFloat(valor) || 0;
      } else if (campo === "precio_unitario") {
        p.precio_unitario = parseFloat(valor) || 0;
      }
    ...
    <div className="max-w-4xl">
      ...
      <div className="flex gap-6">
        <div className="flex-1">
          <label className="mb-1 block text-xs font-medium text-[var(--peja-pizarra)]">Notas</label>
          <textarea
            value={notas}
